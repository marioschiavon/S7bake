...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-primary-300/30 rounded-full blur-3xl" />
      ...
      <div className="w-full max-w-md z-10">
        <div className="glass-panel p-8 sm:p-10 rounded-3xl shadow-xl border border-white/50 backdrop-blur-xl bg-white/80">
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-slate-800 tracking-tight">Bem-vindo de volta</h1>
            <p className="text-slate-500 mt-2 text-center">Faça login para gerenciar suas receitas e produção.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 px-4 bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-2xl shadow-sm hover:shadow-md transition-all flex items-center justify-center group disabled:opacity-70 disabled:cursor-not-allowed mt-2"
            >
              {loading ? (
          ...
          <div className="mt-8 pt-6 border-t border-slate-100 text-center">
            <p className="text-slate-500 text-sm">
              ...
              <Link to="/cadastro" className="text-primary-600 font-bold hover:text-primary-700 transition-colors">
                Cadastre-se
              </Link>
            </p>
          </div>
